...
public class MigrationInfoService {
    private static final Log LOG = LogFactory.getLog(MigrationInfoService.class);
    ...
    public void refresh() {
        ...
        LOG.info(appliedMigrations.toString());
        LOG.info(availableMigrations.toString());
        migrationInfos = mergeAvailableAndAppliedMigrations(availableMigrations, appliedMigrations);
        //LOG.info("The last applied migration is: "+appliedMigrations.get(appliedMigrations.size()-1).getDescription());
